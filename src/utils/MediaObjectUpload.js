...
function uploadMediaFromFormFile(request, createMedia) {
    ...
    return new Promise(function (resolve, reject) {
        form.parse(request, function (err, fields, files) { return __awaiter(_this, void 0, void 0, function () {
            var file, filePath, buffer, metaData;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                buffer = fs_1.default.readFileSync(file.filepath);
                metaData = {
                ...
                LinkedFileStorage_1.LinkedFileStorage.saveFile(filePath, buffer, file.mimetype)
                    .then(function (publicPath) { return __awaiter(_this, void 0, void 0, function () {
                    var media;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, createMedia({
