...
export class ImageObjectProvider extends ShapeProvider {
    ...
    fromDataURL(dataUrl, filePath, metaData) {
        ...
        return LinkedFileStorage.saveFile(filePath, buf, mimeType, true).then(async (publicPath) => {
    ...
    fromFormFile() {
        ...
        //   });
        // });
        return uploadMediaFromFormFile(this.request, (data) => ImageObject.create(data));
    }
}
ImageObjectProvider.ALLOWED_EXTENSIONS = [
    'jpg',
